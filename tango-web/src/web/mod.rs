...
/// Register the offline-shell service worker (../sw.js). The file sits
/// at the site root, not in the asset bundle: its URL sets the
/// registration scope, static hosts can't send Service-Worker-Allowed
