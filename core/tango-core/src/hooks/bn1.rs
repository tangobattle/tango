...
lazy_static! {
    pub static ref MEGAMAN_BNAREE_00: Box<dyn hooks::Hooks + Send + Sync> =
        BN2::new(offsets::MEGAMAN_BNAREE_00);
    pub static ref ROCKMAN_EXEAREJ_00: Box<dyn hooks::Hooks + Send + Sync> =
        BN2::new(offsets::ROCKMAN_EXEAREJ_00);
}
