...
#[rustfmt::skip]
pub static MEGAMAN5_TP_BRBE: Offsets = Offsets {
    ewram: EWRAM_OFFSETS,
    rom: ROMOffsets {
        ...
        round_post_increment_tick:              0x08006c32,
...
#[rustfmt::skip]
pub static MEGAMAN5_TC_BRKE: Offsets = Offsets {
    ewram: EWRAM_OFFSETS,
    rom: ROMOffsets {
...
#[rustfmt::skip]
pub static ROCKEXE5_TOBBRBJ: Offsets = Offsets {
    ewram: EWRAM_OFFSETS,
    rom: ROMOffsets {
...
#[rustfmt::skip]
pub static ROCKEXE5_TOCBRKJ: Offsets = Offsets {
    ewram: EWRAM_OFFSETS,
    rom: ROMOffsets {
