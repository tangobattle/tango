...
#[rustfmt::skip]
pub static MEGAMANBN4BMB4BE_00: Offsets = Offsets {
    ewram: EWRAM_OFFSETS,
    rom: ROMOffsets {
        ...
        round_end_damage_judge_set_win:         0x08007348,
        round_end_damage_judge_set_loss:        0x0800734e,
        round_end_damage_judge_set_draw:        0x08007354,
        round_start_ret:                        0x08006710,
        round_set_ending:                       0x080077da,
...
#[rustfmt::skip]
pub static MEGAMANBN4RSB4WE_00: Offsets = Offsets {
    ewram: EWRAM_OFFSETS,
    rom: ROMOffsets {
        start_screen_jump_table_entry:          0x0802d786,
...
pub static ROCK_EXE4_BMB4BJ_00: Offsets = Offsets {
    ...
    rom: ROMOffsets {
        ...
        round_end_damage_judge_set_win:         0x0800731c,
        round_end_damage_judge_set_loss:        0x08007322,
        round_end_damage_judge_set_draw:        0x08007328,
...
pub static ROCK_EXE4_BMB4BJ_01: Offsets = Offsets {
    ...
    rom: ROMOffsets {
        ...
        round_end_damage_judge_set_win:         0x08007320,
        round_end_damage_judge_set_loss:        0x08007326,
        round_end_damage_judge_set_draw:        0x0800732c,
        round_start_ret:                        0x080066f0,
        round_set_ending:                       0x080077b2,
