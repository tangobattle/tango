...
pub(super) fn traps(hooks: &super::Hooks, shadow_state: crate::shadow::State) -> Vec<Trap> {
    ...
    let mut traps: Vec<Trap> = vec![
        ...
        shadow_round_trap(hooks.offsets.rom.battle_is_p2_ret, &shadow_state, |_shadow_state, round, mut core| {
        ...
        // Special: this trap reads round_state.result_is_in (not just round),
        // and conditionally writes to gpr(0). Doesn't fit shadow_round_trap.
