...
pub(super) struct EWRAMOffsets {
    ...
    /// `+2` the OK-menu sub-state (writing 8 opens it, as pressing Start would).
    /// Drives the chip-select deliberation timer.
...
pub(super) struct ROMOffsets {
    ...
    pub(super) battle_pizzazz_silhouette_mov: u32,
...
pub static B4BJ_01: Offsets = Offsets {
    ...
    rom: ROMOffsets {
        ...
        battle_pizzazz_init_mov:                0x08007468,
        battle_pizzazz_bg_mov:                  0x080074a6,
        battle_pizzazz_self_mov:                0x08014614,
        battle_pizzazz_opponent_mov:            0x0800fc68,
        battle_pizzazz_silhouette_mov:          0x08010ce6,
        battle_pizzazz_final_mov:               0x080074c0,
    },
};
