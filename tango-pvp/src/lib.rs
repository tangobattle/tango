...
//!
//! - [`stepper`]: the per-frame battle simulator. Used in two modes:
//!   `Fastforwarder` — replays a known input window from a saved state on
//!   the primary side; `State` — drives replay-mode playback from boot.
