...
export type MatchSettings={"session_id":string;"input_delay":U32;"match_type":U16;"replay_path":string;"replay_metadata":string;"matchmaking_connect_addr":string;"ice_servers":(string)[];};
