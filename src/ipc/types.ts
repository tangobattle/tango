...
export type MatchSettings={"shadow_save_path":string;"shadow_rom_path":string;"session_id":string;"input_delay":U32;"match_type":U16;"replays_path":string;"replay_metadata":string;"matchmaking_connect_addr":string;"ice_servers":(string)[];};
