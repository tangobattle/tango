...
//! in [`crate::editor::view::navicust::grid::paint`] (shared with the tiny-skia clipboard
...
use crate::editor::view::Action as Msg;
...
/// [`crate::editor::view::navicust::grid::render_part_thumb`]'s `PX`, so the baked
...
impl PartThumb {
    ...
    pub fn new(
        bitmap: &crate::dataview::rom::NavicustBitmap,
...
pub use crate::model::rules::MAX_COPIES_PER_PART;
...
/// hovered cell.
pub fn rotated_offsets(bitmap: &crate::dataview::rom::NavicustBitmap, rot: u8) -> Vec<(isize, isize)> {
    let (h, w) = bitmap.dim();
