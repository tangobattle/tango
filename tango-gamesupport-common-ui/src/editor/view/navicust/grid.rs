//! NaviCust grid rendering. Ported from the legacy app's `gui/save_view/navi_view/navicust_view.rs`.
...
/// [`crate::editor::view::navicust::editor::rotated_offsets`] and `navicust::rotate90`.
pub fn rotate_bitmap(bitmap: &crate::dataview::rom::NavicustBitmap, rot: u8) -> crate::dataview::rom::NavicustBitmap {
