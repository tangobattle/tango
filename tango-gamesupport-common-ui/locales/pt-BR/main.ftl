...
folder-illegal-copies = A quantidade de cópias ({ $used }) excede o limite de { $limit }.
folder-illegal-navi = A quantidade de chips Navi ({ $used }) excede o limite de { $limit }.
folder-illegal-mega = A quantidade de chips Mega ({ $used }) excede o limite de { $limit }.
folder-illegal-giga = A quantidade de chips Giga ({ $used }) excede o limite de { $limit }.
folder-illegal-dark = A quantidade de chips Dark ({ $used }) excede o limite de { $limit }.
folder-illegal-for-game = Este chip não é permitido neste jogo.
folder-illegal-regular-memory = O chip Reg usa { $used }MB; o limite é { $limit }MB.
folder-illegal-tag-memory = Os chips Tag usam { $used }MB; o limite é { $limit }MB.
folder-cannot-add-full = Não é possível adicionar: o Folder está cheio.
folder-add-exceeds-copies = Adicionar este chip excede o limite de { $limit } cópias.
folder-add-exceeds-navi = Adicionar este chip excede o limite de { $limit } chips Navi.
folder-add-exceeds-mega = Adicionar este chip excede o limite de { $limit } chips Mega.
folder-add-exceeds-giga = Adicionar este chip excede o limite de { $limit } chips Giga.
folder-add-exceeds-dark = Adicionar este chip excede o limite de { $limit } chips Dark.
