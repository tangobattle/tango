...
build-violation-patch-cards-exceed-memory = { $patch_cards } usam { $used }MB; o limite é { $limit }MB.
build-violation-folder-not-full = O Folder contém { $used } dos { $required } chips necessários.
build-violation-chip-illegal-for-game = Não é permitido neste jogo ou versão.
build-violation-too-many-copies-of-chip = Há { $used } cópias instaladas; o limite é { $limit }.
build-violation-too-many-navi-chips = O Folder contém { $used } chips Navi; o limite é { $limit }.
build-violation-too-many-mega-chips = O Folder contém { $used } chips Mega; o limite é { $limit }.
build-violation-too-many-giga-chips = O Folder contém { $used } chips Giga; o limite é { $limit }.
build-violation-too-many-dark-chips = O Folder contém { $used } chips Dark; o limite é { $limit }.
