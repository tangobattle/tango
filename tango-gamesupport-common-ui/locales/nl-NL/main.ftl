...
build-violation-patch-cards-exceed-memory = { $patch_cards } gebruiken { $used }MB; de limiet is { $limit }MB.
build-violation-folder-not-full = De map bevat { $used } van de vereiste { $required } chips.
build-violation-chip-illegal-for-game = Niet toegestaan in dit spel of deze versie.
build-violation-too-many-copies-of-chip = Er zijn { $used } exemplaren geïnstalleerd; de limiet is { $limit }.
build-violation-too-many-navi-chips = De map bevat { $used } Navi-chips; de limiet is { $limit }.
build-violation-too-many-mega-chips = De map bevat { $used } Mega-chips; de limiet is { $limit }.
build-violation-too-many-giga-chips = De map bevat { $used } Giga-chips; de limiet is { $limit }.
build-violation-too-many-dark-chips = De map bevat { $used } Dark-chips; de limiet is { $limit }.
