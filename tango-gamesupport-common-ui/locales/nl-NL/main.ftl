...
folder-illegal-copies = Het aantal exemplaren ({ $used }) overschrijdt de limiet van { $limit }.
folder-illegal-navi = Het aantal Navi-chips ({ $used }) overschrijdt de limiet van { $limit }.
folder-illegal-mega = Het aantal Mega-chips ({ $used }) overschrijdt de limiet van { $limit }.
folder-illegal-giga = Het aantal Giga-chips ({ $used }) overschrijdt de limiet van { $limit }.
folder-illegal-dark = Het aantal Dark-chips ({ $used }) overschrijdt de limiet van { $limit }.
folder-illegal-for-game = Deze chip is niet toegestaan in dit spel.
folder-illegal-regular-memory = De Reg-chip gebruikt { $used }MB; de limiet is { $limit }MB.
folder-illegal-tag-memory = De Tag-chips gebruiken { $used }MB; de limiet is { $limit }MB.
folder-cannot-add-full = Kan niet toevoegen: de map is vol.
folder-add-exceeds-copies = Deze chip overschrijdt de limiet van { $limit } exemplaren.
folder-add-exceeds-navi = Deze chip overschrijdt de Navi-chiplimiet van { $limit }.
folder-add-exceeds-mega = Deze chip overschrijdt de Mega-chiplimiet van { $limit }.
folder-add-exceeds-giga = Deze chip overschrijdt de Giga-chiplimiet van { $limit }.
folder-add-exceeds-dark = Deze chip overschrijdt de Dark-chiplimiet van { $limit }.
