...
build-violation-folder-not-full = Der Ordner enthält { $used } der erforderlichen { $required } Chips.
build-violation-chip-illegal-for-game = In diesem Spiel oder dieser Version nicht erlaubt.
build-violation-too-many-copies-of-chip = Es sind { $used } Kopien installiert; das Limit beträgt { $limit }.
build-violation-too-many-navi-chips = Der Ordner enthält { $used } Navi-Chips; das Limit beträgt { $limit }.
build-violation-too-many-mega-chips = Der Ordner enthält { $used } Mega-Chips; das Limit beträgt { $limit }.
build-violation-too-many-giga-chips = Der Ordner enthält { $used } Giga-Chips; das Limit beträgt { $limit }.
build-violation-too-many-dark-chips = Der Ordner enthält { $used } Dark-Chips; das Limit beträgt { $limit }.
