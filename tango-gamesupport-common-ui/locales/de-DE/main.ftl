...
folder-illegal-copies = Die Anzahl der Kopien ({ $used }) überschreitet das Limit von { $limit }.
folder-illegal-navi = Die Anzahl der Navi-Chips ({ $used }) überschreitet das Limit von { $limit }.
folder-illegal-mega = Die Anzahl der Mega-Chips ({ $used }) überschreitet das Limit von { $limit }.
folder-illegal-giga = Die Anzahl der Giga-Chips ({ $used }) überschreitet das Limit von { $limit }.
folder-illegal-dark = Die Anzahl der Dark-Chips ({ $used }) überschreitet das Limit von { $limit }.
folder-illegal-for-game = Dieser Chip ist in diesem Spiel nicht erlaubt.
folder-illegal-regular-memory = Der Reg-Chip belegt { $used }MB; das Limit beträgt { $limit }MB.
folder-illegal-tag-memory = Die Tag-Chips belegen { $used }MB; das Limit beträgt { $limit }MB.
folder-cannot-add-full = Hinzufügen nicht möglich: Der Ordner ist voll.
folder-add-exceeds-copies = Durch diesen Chip wird das Limit von { $limit } Kopien überschritten.
folder-add-exceeds-navi = Durch diesen Chip wird das Navi-Chip-Limit von { $limit } überschritten.
folder-add-exceeds-mega = Durch diesen Chip wird das Mega-Chip-Limit von { $limit } überschritten.
folder-add-exceeds-giga = Durch diesen Chip wird das Giga-Chip-Limit von { $limit } überschritten.
folder-add-exceeds-dark = Durch diesen Chip wird das Dark-Chip-Limit von { $limit } überschritten.
