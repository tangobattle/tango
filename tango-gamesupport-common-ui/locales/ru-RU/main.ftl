...
folder-illegal-copies = Количество копий ({ $used }) превышает лимит { $limit }.
folder-illegal-navi = Количество Нави-чипов ({ $used }) превышает лимит { $limit }.
folder-illegal-mega = Количество Мега-чипов ({ $used }) превышает лимит { $limit }.
folder-illegal-giga = Количество Гига-чипов ({ $used }) превышает лимит { $limit }.
folder-illegal-dark = Количество Дарк-чипов ({ $used }) превышает лимит { $limit }.
folder-illegal-for-game = Этот чип недопустим в этой игре.
folder-illegal-regular-memory = Reg-чип занимает { $used }MB; лимит — { $limit }MB.
folder-illegal-tag-memory = Tag-чипы занимают { $used }MB; лимит — { $limit }MB.
folder-cannot-add-full = Нельзя добавить: папка заполнена.
folder-add-exceeds-copies = Добавление этого чипа превышает лимит копий: { $limit }.
folder-add-exceeds-navi = Добавление этого чипа превышает лимит Нави-чипов: { $limit }.
folder-add-exceeds-mega = Добавление этого чипа превышает лимит Мега-чипов: { $limit }.
folder-add-exceeds-giga = Добавление этого чипа превышает лимит Гига-чипов: { $limit }.
folder-add-exceeds-dark = Добавление этого чипа превышает лимит Дарк-чипов: { $limit }.
