...
build-violation-folder-not-full = В папке { $used } из { $required } необходимых чипов.
build-violation-chip-illegal-for-game = Недопустимо в этой игре или версии.
build-violation-too-many-copies-of-chip = Установлено копий: { $used }; лимит — { $limit }.
build-violation-too-many-navi-chips = В папке { $used } Нави-чипов; лимит — { $limit }.
build-violation-too-many-mega-chips = В папке { $used } Мега-чипов; лимит — { $limit }.
build-violation-too-many-giga-chips = В папке { $used } Гига-чипов; лимит — { $limit }.
build-violation-too-many-dark-chips = В папке { $used } Дарк-чипов; лимит — { $limit }.
