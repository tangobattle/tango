...
folder-illegal-copies = Số bản sao ({ $used }) vượt quá giới hạn { $limit }.
folder-illegal-navi = Số chip Navi ({ $used }) vượt quá giới hạn { $limit }.
folder-illegal-mega = Số chip Mega ({ $used }) vượt quá giới hạn { $limit }.
folder-illegal-giga = Số chip Giga ({ $used }) vượt quá giới hạn { $limit }.
folder-illegal-dark = Số chip Dark ({ $used }) vượt quá giới hạn { $limit }.
folder-illegal-for-game = Chip này không hợp lệ trong trò chơi này.
folder-illegal-regular-memory = Chip Reg dùng { $used }MB; giới hạn là { $limit }MB.
folder-illegal-tag-memory = Các chip Tag dùng { $used }MB; giới hạn là { $limit }MB.
folder-cannot-add-full = Không thể thêm: Folder đã đầy.
folder-add-exceeds-copies = Thêm chip này sẽ vượt quá giới hạn { $limit } bản sao.
folder-add-exceeds-navi = Thêm chip này sẽ vượt quá giới hạn { $limit } chip Navi.
folder-add-exceeds-mega = Thêm chip này sẽ vượt quá giới hạn { $limit } chip Mega.
folder-add-exceeds-giga = Thêm chip này sẽ vượt quá giới hạn { $limit } chip Giga.
folder-add-exceeds-dark = Thêm chip này sẽ vượt quá giới hạn { $limit } chip Dark.
