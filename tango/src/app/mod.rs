...
impl App {
    ...
    fn replay_stats_takeover(
        ...
        let (partial_tx, partial_rx) = futures::channel::mpsc::unbounded::<tango_backend_mgba::analysis::MatchStats>();
        let done: std::sync::Arc<std::sync::Mutex<Option<tango_backend_mgba::analysis::MatchStats>>> = Default::default();
