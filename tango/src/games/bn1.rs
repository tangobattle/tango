...
lazy_static! {
    pub static ref AREE_00: Box<dyn games::Hooks + Send + Sync> = Hooks::new(offsets::AREE_00);
    pub static ref AREJ_00: Box<dyn games::Hooks + Send + Sync> = Hooks::new(offsets::AREJ_00);
}
