...
static BACKGROUND: LazyImage =
    LazyLock::new(|| image::load_from_memory(include_bytes!("../../backgrounds/45.jpg")).unwrap());
static LOGO: LazyImage =
    LazyLock::new(|| image::load_from_memory(include_bytes!("../../logos/exe45.png")).unwrap());
