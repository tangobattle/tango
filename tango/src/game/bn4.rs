...
static EXE4RS_DARK997: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/dark_hp_997_rs_jp.raw", true, false, RedSun);
static EXE4RS_LIGHT999: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_999_rs_jp.raw", true, false, RedSun);
static EXE4RS_LIGHT1000: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_1000_rs_jp.raw", true, false, RedSun);
...
impl Game for EXE4RSImpl {
    fn gamedb_entry(&self) -> &'static (dyn tango_gamedb::Game + Send + Sync) { &tango_gamedb::B4WJ_01 }
    fn hooks(&self) -> &'static (dyn tango_pvp::hooks::Hooks + Send + Sync) { &tango_pvp::game::bn4::B4WJ_01 }
    fn match_types(&self) -> &'static [usize] { MATCH_TYPES }
    fn save_templates(&self) -> &'static [(&'static str, &'static (dyn SaveTrait + Send + Sync))] { EXE4RS_T.as_slice() }
}

// ---------------- EXE4 Blue Moon (JP) ----------------
static EXE4BM_DARK997: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/dark_hp_997_bm_jp.raw", true, false, BlueMoon);
static EXE4BM_LIGHT999: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_999_bm_jp.raw", true, false, BlueMoon);
static EXE4BM_LIGHT1000: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_1000_bm_jp.raw", true, false, BlueMoon);
...
impl Game for EXE4BMImpl {
    fn gamedb_entry(&self) -> &'static (dyn tango_gamedb::Game + Send + Sync) { &tango_gamedb::B4BJ_01 }
    fn hooks(&self) -> &'static (dyn tango_pvp::hooks::Hooks + Send + Sync) { &tango_pvp::game::bn4::B4BJ_01 }
    fn match_types(&self) -> &'static [usize] { MATCH_TYPES }
    fn save_templates(&self) -> &'static [(&'static str, &'static (dyn SaveTrait + Send + Sync))] { EXE4BM_T.as_slice() }
}

// ---------------- BN4 Red Sun (US) ----------------
static BN4RS_DARK997: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/dark_hp_997_rs_us.raw", false, true, RedSun);
static BN4RS_LIGHT999: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_999_rs_us.raw", false, true, RedSun);
static BN4RS_LIGHT1000: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_1000_rs_us.raw", false, true, RedSun);
...
impl Game for BN4RSImpl {
    fn gamedb_entry(&self) -> &'static (dyn tango_gamedb::Game + Send + Sync) { &tango_gamedb::B4WE_00 }
    fn hooks(&self) -> &'static (dyn tango_pvp::hooks::Hooks + Send + Sync) { &tango_pvp::game::bn4::B4WE_00 }
    fn match_types(&self) -> &'static [usize] { MATCH_TYPES }
    fn save_templates(&self) -> &'static [(&'static str, &'static (dyn SaveTrait + Send + Sync))] { BN4RS_T.as_slice() }
}

// ---------------- BN4 Blue Moon (US) ----------------
static BN4BM_DARK997: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/dark_hp_997_bm_us.raw", false, true, BlueMoon);
static BN4BM_LIGHT999: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_999_bm_us.raw", false, true, BlueMoon);
static BN4BM_LIGHT1000: LazyLock<tango_dataview::game::bn4::save::Save> =
    bn4_save!("../../../tango/src/game/bn4/save/light_hp_1000_bm_us.raw", false, true, BlueMoon);
...
impl Game for BN4BMImpl {
    fn gamedb_entry(&self) -> &'static (dyn tango_gamedb::Game + Send + Sync) { &tango_gamedb::B4BE_00 }
    fn hooks(&self) -> &'static (dyn tango_pvp::hooks::Hooks + Send + Sync) { &tango_pvp::game::bn4::B4BE_00 }
    fn match_types(&self) -> &'static [usize] { MATCH_TYPES }
    fn save_templates(&self) -> &'static [(&'static str, &'static (dyn SaveTrait + Send + Sync))] { BN4BM_T.as_slice() }
}
