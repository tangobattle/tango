...
//!
//! Both the lobby-relayed path ([`super::lobby_rtc`]) and the signaling-free
//! direct path ([`super::direct_rtc`]) create exactly these. The labels, stream
//! ids, and reliability live here and nowhere else so the two peers can't drift
//! out of agreement.
//!
...
/// Label + init for the unreliable in-match channel. Mirror of
/// [`control_channel`] — created alongside it, on its own fixed stream id.
