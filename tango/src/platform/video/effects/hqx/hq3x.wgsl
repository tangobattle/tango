// hq3x — faithful WGSL port of the hqx pixel-art upscaler: a 256-entry pattern
...
fn fs_main(in: VsOut) -> @location(0) vec4<f32> {
    ...
    switch pattern {
        case 0u, 1u, 4u, 32u, 128u, 5u, 132u, 160u, 33u, 129u, 36u, 133u, 164u, 161u, 37u, 165u: {
            ...
            out[2] = interp2(w[5], w[2], w[6]);
            out[3] = interp1(w[5], w[4]);
            out[4] = w[5];
            out[5] = interp1(w[5], w[6]);
            out[6] = interp2(w[5], w[8], w[4]);
            out[7] = interp1(w[5], w[8]);
            out[8] = interp2(w[5], w[6], w[8]);
        }
        ...
        case 18u, 50u: {
            ...
            if (diff(w[2], w[6])) {
                ...
                out[1] = interp3(w[5], w[2]);
                out[2] = interp4(w[5], w[2], w[6]);
                out[5] = interp3(w[5], w[6]);
            }
            out[3] = interp1(w[5], w[4]);
            out[4] = w[5];
            out[6] = interp2(w[5], w[8], w[4]);
        ...
        case 80u, 81u: {
            ...
            if (diff(w[6], w[8])) {
                ...
                out[5] = interp3(w[5], w[6]);
                out[7] = interp3(w[5], w[8]);
                out[8] = interp4(w[5], w[6], w[8]);
            }
        }
        case 72u, 76u: {
            out[0] = interp1(w[5], w[1]);
            ...
            if (diff(w[8], w[4])) {
                ...
                out[3] = interp3(w[5], w[4]);
                out[6] = interp4(w[5], w[8], w[4]);
                out[7] = interp3(w[5], w[8]);
            }
            out[8] = interp1(w[5], w[9]);
        }
