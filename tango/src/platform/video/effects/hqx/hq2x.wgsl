// hq2x — faithful WGSL port of the hqx pixel-art upscaler: a 256-entry pattern
...
fn fs_main(in: VsOut) -> @location(0) vec4<f32> {
    ...
    switch pattern {
        case 0u, 1u, 4u, 32u, 128u, 5u, 132u, 160u, 33u, 129u, 36u, 133u, 164u, 161u, 37u, 165u: {
            out[0] = interp2(w[5], w[4], w[2]);
            out[1] = interp2(w[5], w[2], w[6]);
            out[2] = interp2(w[5], w[8], w[4]);
            out[3] = interp2(w[5], w[6], w[8]);
        }
        case 2u, 34u, 130u, 162u: {
            out[0] = interp2(w[5], w[1], w[4]);
            out[1] = interp2(w[5], w[3], w[6]);
            out[2] = interp2(w[5], w[8], w[4]);
            out[3] = interp2(w[5], w[6], w[8]);
        }
        case 16u, 17u, 48u, 49u: {
            out[0] = interp2(w[5], w[4], w[2]);
            out[1] = interp2(w[5], w[3], w[2]);
            out[2] = interp2(w[5], w[8], w[4]);
            out[3] = interp2(w[5], w[9], w[8]);
        }
        case 64u, 65u, 68u, 69u: {
            out[0] = interp2(w[5], w[4], w[2]);
            out[1] = interp2(w[5], w[2], w[6]);
            out[2] = interp2(w[5], w[7], w[4]);
            out[3] = interp2(w[5], w[9], w[6]);
        }
        case 8u, 12u, 136u, 140u: {
            out[0] = interp2(w[5], w[1], w[2]);
            out[1] = interp2(w[5], w[2], w[6]);
            out[2] = interp2(w[5], w[7], w[8]);
            out[3] = interp2(w[5], w[6], w[8]);
        }
        ...
        case 96u, 97u, 100u, 101u: {
            out[0] = interp2(w[5], w[4], w[2]);
            out[1] = interp2(w[5], w[2], w[6]);
            out[2] = interp1(w[5], w[4]);
            out[3] = interp2(w[5], w[9], w[6]);
        }
        case 40u, 44u, 168u, 172u: {
            out[0] = interp2(w[5], w[1], w[2]);
            out[1] = interp2(w[5], w[2], w[6]);
            out[2] = interp1(w[5], w[8]);
            out[3] = interp2(w[5], w[6], w[8]);
        }
        ...
        case 19u, 51u: {
            if (diff(w[2], w[6])) {
                ...
                out[0] = interp6(w[5], w[2], w[4]);
                out[1] = interp9(w[5], w[2], w[6]);
            }
            out[2] = interp2(w[5], w[8], w[4]);
            out[3] = interp2(w[5], w[9], w[8]);
        }
        ...
        case 84u, 85u: {
            ...
            if (diff(w[6], w[8])) {
                ...
                out[1] = interp6(w[5], w[6], w[2]);
                out[3] = interp9(w[5], w[6], w[8]);
            }
            out[2] = interp2(w[5], w[7], w[4]);
        }
        case 112u, 113u: {
        ...
        case 200u, 204u: {
            ...
            if (diff(w[8], w[4])) {
                ...
                out[2] = interp9(w[5], w[8], w[4]);
                out[3] = interp6(w[5], w[8], w[6]);
            }
        }
        case 73u, 77u: {
            if (diff(w[8], w[4])) {
        ...
        case 42u, 170u: {
            if (diff(w[4], w[2])) {
                ...
                out[0] = interp9(w[5], w[4], w[2]);
                out[2] = interp6(w[5], w[4], w[8]);
            }
            out[1] = interp2(w[5], w[3], w[6]);
            out[3] = interp2(w[5], w[6], w[8]);
        }
        ...
        case 58u: {
            if (diff(w[4], w[2])) {
                ...
                out[0] = interp7(w[5], w[4], w[2]);
            }
            if (diff(w[2], w[6])) {
                out[1] = interp1(w[5], w[3]);
            } else {
                out[1] = interp7(w[5], w[2], w[6]);
            }
            out[2] = interp1(w[5], w[8]);
            out[3] = interp2(w[5], w[9], w[8]);
        }
