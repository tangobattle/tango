...
discord-presence-in-training = 訓練中
...
training-record = 為假人錄製套路
training-record-stop = 停止錄製
training-playback = 循環播放錄製的套路
training-dummy-save = 假人的存檔
training-dummy-save-mirror = 與你相同（鏡像對戰）
play-fight = 戰鬥
play-cancel = 離開
