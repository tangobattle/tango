...
play-training = 訓練
training-pip = 對手畫面
training-opponent-view = 對手畫面顯示
opponent-view-off = 關閉
opponent-view-picture-in-picture = 子母畫面
...
session-build-warning-title = 對手的配置無效
session-build-warning-dismiss = 關閉配置警告
session-build-warning-show-violations = 查看違規項目
session-build-warning-hide-violations = 隱藏違規項目
...
playback-options = 選項
playback-speed = 速度
playback-input-display = 輸入顯示 (I)
playback-pip = 對手畫面 (P)
playback-opponent-view = 對手畫面顯示 (P)
playback-swap-perspective = 對手視角 (Tab)
