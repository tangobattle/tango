...
training-chips-clear = Xóa
training-chips-search = Tìm chip…
training-chips-unavailable = Ép chip không khả dụng cho trò chơi này
...
training-dummy-save = Save của hình nộm
training-dummy-save-mirror = Giống của bạn (đấu gương)
play-fight = Đấu!
