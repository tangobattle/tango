...
opponent-view-off = Выкл.
opponent-view-picture-in-picture = Картинка в картинке
opponent-view-stack-horizontally = Расположить горизонтально
opponent-view-stack-vertically = Расположить вертикально
...
session-build-warning-show-violations = Показать нарушения
session-build-warning-hide-violations = Скрыть нарушения
...
replays-export-scale-raw = без обработки
...
playback-input-display = Отображение ввода (I)
playback-pip = Экран соперника (P)
playback-opponent-view = Отображение соперника (P)
playback-swap-perspective = Вид соперника (Tab)
