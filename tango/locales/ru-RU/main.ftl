...
play-status-negotiate-version-too-old = Другой игрок использует более старую версию Trill.
play-status-negotiate-version-too-new = Другой игрок использует более новую версию Trill.
...
welcome-title = Добро пожаловать в Trill!
