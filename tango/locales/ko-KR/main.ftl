...
crash =
    Tango가 예상치 못한 이유로 중단되었습니다
    
    버그 제보 시 다음 로그 파일을 포함해 주시기 바랍니다.
...
playback-forfeit = Forfeit
playback-forfeit-prompt = Forfeit this match?
playback-forfeit-detail = You will disconnect from your opponent.
