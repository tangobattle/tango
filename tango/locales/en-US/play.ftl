...
lobby-issue-no-remote-rom = The opponent does not have a copy of the requested game: {$game_name}
lobby-issue-no-local-patch = You do not have a copy of the opponent's patch: {$patch_name} v${patch_version}
lobby-issue-no-remote-patch = The opponent does not have a copy of the requested patch: {$patch_name} v${patch_version}
lobby-issue-no-remote-patches = The opponent does not have any copy of the requested patch: {$patch_name}
lobby-issue-unrecognized-game = The opponent selected an unrecognized game.
lobby-issue-incompatible = The selected game is not compatible with the opponent's.
lobby-issue-match-type-mismatch = The selected match type is not the same as the opponent's.
