...
training-chips-clear = Clear
training-chips-search = Search chips…
training-chips-unavailable = Chip forcing isn't available for this game
...
training-dummy-save = Dummy's save
training-dummy-save-mirror = Same as yours (mirror match)
play-fight = Fight
play-cancel = Leave
