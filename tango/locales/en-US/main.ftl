...
training-side-p2 = Player 2
training-seed = Seed
training-seed-placeholder = Random
training-start = Start
training-cancel = Cancel
training-pause = Pause
training-frame-advance = Frame advance
training-restart = Restart round
training-dummy-idle = Dummy: idle
training-dummy-possess = Dummy: control
training-dummy-record = Dummy: record
training-dummy-playback = Dummy: play recording
training-dummy-attack = Dummy: use chips
training-loop = Loop recording
training-auto-direct = Pick the dummy's chips when its custom screen opens
training-slot = Checkpoint { $number }
training-save-state = Save checkpoint
training-load-state = Load checkpoint
...
input-key-training-possess = Control dummy
input-key-training-record = Record dummy
input-key-training-playback = Play recording
input-key-training-restart = Restart round
input-key-training-save-state = Save checkpoint
input-key-training-load-state = Load checkpoint
input-key-training-pause = Pause
input-key-training-frame-advance = Frame advance
settings-input-training = Training
...
settings-accent-bass-gold = Bass Gold
