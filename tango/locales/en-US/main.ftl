...
training-behavior = Dummy behavior
training-behavior-stand = Stand
training-behavior-use-chips = Use chips
...
training-reset = Reset the rep
training-set-drill-point = Set the drill point here
training-author = Author the dummy (act out its part)
training-authoring = Acting as the dummy — press Author or Reset when done
training-auto-reset = Reset the rep instead of ending the round
...
input-key-training-reset = Reset rep
input-key-training-author = Author dummy
input-key-training-set-drill-point = Set drill point
