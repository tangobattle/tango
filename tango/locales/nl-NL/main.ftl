...
play-status-connecting = Verbinden…
play-status-negotiating = Onderhandelen…
play-status-lobby = In de lobby
play-status-failed = Verbinding mislukt
lobby-waiting = Wachten op instellingen…
...
session-show-opponent = Tegenstander tonen
session-hide-opponent = Tegenstander verbergen
...
replays-filter-game = Spel
replays-filter-opponent = Tegenstander
