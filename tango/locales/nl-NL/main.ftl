...
training-chips-clear = Wissen
training-chips-search = Chips zoeken…
training-chips-unavailable = Chips forceren is niet beschikbaar voor dit spel
...
training-dummy-save = Opslag van de dummy
training-dummy-save-mirror = Zelfde als die van jou (spiegelduel)
play-fight = Vechten!
