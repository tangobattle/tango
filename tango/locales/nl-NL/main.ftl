...
opponent-view-off = Uit
opponent-view-picture-in-picture = Beeld-in-beeld
opponent-view-stack-horizontally = Horizontaal stapelen
opponent-view-stack-vertically = Verticaal stapelen
...
replays-export-scale-raw = onbewerkt
...
playback-input-display = Invoerweergave (I)
playback-pip = Scherm van tegenstander (P)
playback-opponent-view = Tegenstanderweergave (P)
