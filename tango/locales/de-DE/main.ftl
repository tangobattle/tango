...
opponent-view-off = Aus
opponent-view-picture-in-picture = Bild-in-Bild
opponent-view-stack-horizontally = Horizontal anordnen
opponent-view-stack-vertically = Vertikal anordnen
...
play-play = Spielen
play-you = Du
patches-refresh = Aktualisieren
patches-refreshing = Wird aktualisiert…
patches-refresh-failed = Aktualisieren fehlgeschlagen: { $error }
patches-install = Installieren
patches-uninstall = Entfernen
patches-installed = Installiert
patches-cancel = Download abbrechen
replays-patch-downloading = Patch dieser Wiederholung wird heruntergeladen…
replays-patch-downloading-progress = Patch dieser Wiederholung wird heruntergeladen… { $percent }%
replays-patch-download-failed = Patch dieser Wiederholung konnte nicht heruntergeladen werden
patches-downloading = Wird heruntergeladen…
patches-downloading-progress = Wird heruntergeladen… { $percent }%
patches-download-failed = Download fehlgeschlagen
patches-retry = Erneut versuchen
patches-reveal-package = Paket anzeigen
...
patches-filter-installed = Installiert
patches-filter-available = Verfügbar
...
settings-streamer-mode = Streamer-Modus
...
play-patch-download-failed = ↓ fehlgeschlagen
...
lobby-compat-fetching-patch = Patch für dieses Match wird heruntergeladen…
...
session-build-warning-show-violations = Verstöße anzeigen
session-build-warning-hide-violations = Verstöße ausblenden
...
session-results-disconnected = Gegner hat die Verbindung getrennt
session-results-no-rounds = Das Match endete, bevor eine Runde entschieden wurde.
...
replays-analyzing = Replay wird analysiert…
...
replays-export-scale-raw = roh
replays-export-rounds = Runden:
replays-export-setup = Vorbereitung
replays-export-rounds-analyzing = Runden: Match wird analysiert…
replays-export-save-as = Speichern unter…
playback-close = Schließen
playback-options = Optionen
playback-speed = Geschwindigkeit
playback-input-display = Eingabeanzeige (I)
playback-pip = Bildschirm des Gegners
playback-opponent-view = Gegneransicht
playback-swap-perspective = Perspektive des Gegners (Tab)
...
replays-queue-play = Warteschlange abspielen
replays-queue-clear = Warteschlange leeren
replays-queue-remove = Aus Warteschlange entfernen
replays-queue-missing = Wiederholungsdatei fehlt
replays-queue-up-next = { $n } als Nächstes
replays-scanning = Wiederholungen werden durchsucht…
...
patches-scanning = Patches werden durchsucht…
patches-readme-placeholder = Dieser Patch hat keine README.
patches-netplay-compatibility = Netplay-Kompatibilität:
patches-netplay-isolated = Nur diese Version
patches-netplay-vanilla = Spielbar mit dem ungepatchten Spiel
patches-netplay-group = Spielbar mit: { $group }
...
playback-exit-hold-detail = Esc gedrückt halten zum Beenden — loslassen zum Abbrechen.
playback-priming-match = Partie wird gestartet…
playback-priming-match-detail = Beide Spiele werden bis zu ihrem Kampf hochgefahren.
playback-priming-peer = Warten auf deinen Gegner…
playback-priming-peer-detail = Sein Spiel startet noch.
playback-priming-replay = Wiederholung wird gestartet…
playback-priming-replay-detail = Die Spiele werden bis zu ihrem Kampf hochgefahren.
...
package-editor-title = Paketeditor
package-editor-undo = Rückgängig
package-editor-redo = Wiederholen
package-editor-save = Speichern
package-editor-save-as = Speichern unter…
package-editor-reload = Pakete neu laden
package-editor-reload-dirty = Speichere deine Änderungen, bevor du die Pakete neu lädst.
package-editor-read-only = Dieses Dokument ist schreibgeschützt.
package-editor-saved = Gespeichert.
package-editor-close-prompt = Änderungen vor dem Schließen speichern?
package-editor-save-close = Speichern und schließen
package-editor-discard = Änderungen verwerfen
package-editor-keep-editing = Weiter bearbeiten
package-editor-error = Der Vorgang konnte nicht abgeschlossen werden: { $error }
package-editor-unknown-action = Unbekannte Host-Aktion: { $id }
package-editor-not-configured = Der Editor wurde noch nicht konfiguriert.
package-editor-no-save-path = Dieser Spielstand hat keine zugehörige Datei.
