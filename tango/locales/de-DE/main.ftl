...
training-chips-clear = Leeren
training-chips-search = Chips suchen…
training-chips-unavailable = Chip-Erzwingen ist für dieses Spiel nicht verfügbar
...
training-dummy-save = Speicherstand des Dummys
training-dummy-save-mirror = Wie deiner (Spiegelduell)
play-fight = Kämpfen!
