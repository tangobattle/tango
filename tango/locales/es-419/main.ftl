...
training-chips-clear = Limpiar
training-chips-search = Buscar chips…
training-chips-unavailable = Forzar chips no está disponible en este juego
...
training-dummy-save = Partida del dummy
training-dummy-save-mirror = Igual que la tuya (duelo espejo)
