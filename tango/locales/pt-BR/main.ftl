...
training-swap = Trocar de lado
training-chips = Chips forçados
training-chips-clear = Limpar
training-chips-search = Buscar chips…
training-chips-unavailable = Forçar chips não está disponível neste jogo
training-dummy-auto-confirm = Chips do dummy: confirmação automática
training-dummy-auto-possess = Chips do dummy: você escolhe
training-dummy-manual = Chips do dummy: manual
training-record = Gravar rotina para o dummy
training-record-stop = Parar gravação
training-playback = Repetir a rotina gravada
training-dummy-save = Save do dummy
training-dummy-save-mirror = Igual ao seu (espelho)
play-fight = Batalhar!
...
play-play = Jogar
play-you = Você
patches-refresh = Atualizar
patches-refreshing = Atualizando…
patches-refresh-failed = Falha ao atualizar: { $error }
patches-install = Instalar
patches-uninstall = Remover
patches-installed = Instalado
patches-cancel = Cancelar download
replays-patch-downloading = Baixando o patch deste replay…
replays-patch-downloading-progress = Baixando o patch deste replay… { $percent }%
replays-patch-download-failed = Não foi possível baixar o patch deste replay
patches-downloading = Baixando…
patches-downloading-progress = Baixando… { $percent }%
patches-download-failed = Falha no download
patches-retry = Tentar novamente
patches-reveal-package = Mostrar pacote
...
discord-presence-in-training = Em treino
...
play-patch-download-failed = ↓ falhou
...
lobby-compat-fetching-patch = Baixando o patch para esta partida…
...
session-results-disconnected = O oponente desconectou
session-results-no-rounds = A partida terminou antes de um round ser decidido.
...
session-results-watch-replay = Assistir replay
...
replays-analyzing = Analisando replay…
...
replays-export-setup = Preparação
replays-export-rounds-analyzing = Rounds: analisando a partida…
...
replays-queue-play = Reproduzir fila
replays-queue-clear = Limpar fila
replays-queue-remove = Remover da fila
replays-queue-missing = Arquivo de replay não encontrado
replays-queue-up-next = { $n } a seguir
replays-scanning = Analisando replays…
...
patches-netplay-isolated = Somente esta versão
patches-netplay-vanilla = Joga com o jogo sem patch
patches-netplay-group = Joga com: { $group }
...
input-key-training-swap = Treino: trocar de lado
...
playback-exit-hold = Saindo…
playback-exit-hold-detail = Segure Esc para sair — solte para cancelar.
playback-priming-match = Iniciando a partida…
playback-priming-match-detail = Os dois jogos estão iniciando até a batalha.
playback-priming-peer = Aguardando o oponente…
playback-priming-peer-detail = O jogo dele ainda está iniciando.
playback-priming-replay = Iniciando o replay…
playback-priming-replay-detail = Os jogos estão iniciando até a batalha.
