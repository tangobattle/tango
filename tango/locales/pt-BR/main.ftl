...
opponent-view-off = Desativado
opponent-view-picture-in-picture = Imagem em imagem
opponent-view-stack-horizontally = Empilhar horizontalmente
opponent-view-stack-vertically = Empilhar verticalmente
...
session-build-warning-title = O oponente tem uma configuração inválida
session-build-warning-dismiss = Fechar aviso de configuração
session-build-warning-show-violations = Ver violações
session-build-warning-hide-violations = Ocultar violações
...
playback-input-display = Exibir entradas (I)
playback-pip = Tela do oponente (P)
playback-opponent-view = Visualização do oponente (P)
playback-swap-perspective = Perspectiva do oponente (Tab)
