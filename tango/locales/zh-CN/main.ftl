...
play-status-connecting = 正在连接…
play-status-negotiating = 正在协商…
play-status-lobby = 大厅中
play-status-failed = 连接失败
lobby-waiting = 等待设置…
lobby-no-game = （未选择游戏）
lobby-latency = 延迟
...
session-show-opponent = 显示对手
session-hide-opponent = 隐藏对手
...
navicust-grid-size = 网格
navicust-parts = 已装部件
navicust-empty = （未装）
patch-cards-count = 已装备
patch-cards-4-title = Patch Cards (4)
save-empty = 此存档没有该视图的数据。
play-no-selection = 请选择要查看的游戏与存档。
replays-filter-game = 游戏
replays-filter-opponent = 对手
...
replays-export-scale-na-lossless = （无损 — 忽略缩放）
