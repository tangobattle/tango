...
empty-no-patches-title = 未安装任何补丁
empty-no-patches-body = 点击“更新”即可从补丁仓库下载最新的补丁合集。
empty-no-replays-title = 还没有录像
empty-no-replays-body = 你的对战录像会自动记录在这里。
play-no-patch = 无补丁
