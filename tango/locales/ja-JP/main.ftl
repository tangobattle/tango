...
training-chips-clear = クリア
training-chips-search = チップを検索…
training-chips-unavailable = このゲームではチップ強制は使えません
...
training-dummy-save = ダミーのセーブ
training-dummy-save-mirror = 自分と同じ（ミラーマッチ）
play-fight = 対戦
play-cancel = キャンセル
