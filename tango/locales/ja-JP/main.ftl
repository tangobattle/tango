...
empty-no-patches-title = パッチがインストールされていません
empty-no-patches-body = 「更新」でパッチリポジトリから最新のパッチをダウンロードできます。
empty-no-replays-title = リプレイはまだありません
empty-no-replays-body = 対戦のリプレイはここに自動的に記録されます。
play-no-patch = パッチなし
