...
build-violation-chip-code-unavailable = This code is not available for this chip.
...
short-save = Save file is too short.
unsupported-save-shift = Unsupported save shift.
invalid-checksum = Save checksum does not match.
invalid-folder-count = Save must contain between one and three folders.
invalid-slot = Folder { $folder }, slot { $slot }: invalid chip ID or code.

short-rom-header = ROM header is truncated.
short-chip-table = ROM chip table is truncated.
