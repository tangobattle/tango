...
pub const EN_PATCH_CARDS: &[Option<super::PatchCard4>; super::super::NUM_PATCH_CARD4S] = &[
    ...
    Some(super::PatchCard4 {
        name: "Buster Attack 10",
        slot: 0,
        effect: "Buster Attack 10",
        bug: Some("HP Bug"),
    }),
    Some(super::PatchCard4 {
        name: "Charge Shot Switch",
        slot: 4,
    ...
    Some(super::PatchCard4 {
        name: "B+Left Ability Activation",
        slot: 3,
    ...
    Some(super::PatchCard4 {
        name: "Buster Attack 15",
        slot: 0,
        effect: "Buster Attack 15",
    ...
    Some(super::PatchCard4 {
        name: "All Guard 1/2",
        slot: 2,
        effect: "All Guard 1/2",
        bug: Some("HP Bug"),
    }),
    Some(super::PatchCard4 {
        name: "All Guard 2/2",
        slot: 3,
        effect: "All Guard 2/2",
        bug: Some("HP Bug"),
    }),
    Some(super::PatchCard4 {
        name: "First Life Aura",
        slot: 2,
    ...
    Some(super::PatchCard4 {
        name: "FullCustom Charge 1/2",
        slot: 3,
        effect: "FullCustom Charge 1/2",
        bug: None,
    }),
    Some(super::PatchCard4 {
        name: "FullCustom Charge 2/2",
        slot: 4,
        effect: "FullCustom Charge 2/2",
        bug: None,
    }),
    Some(super::PatchCard4 {
        name: "Panel Change",
