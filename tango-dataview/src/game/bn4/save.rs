...
impl crate::save::Save for Save {
    ...
    fn folder_limits(&self, assets: &dyn crate::rom::Assets) -> crate::save::FolderLimits {
        ...
        let crate::save::PatchCardsView::PatchCard4s(pc) = self.view_patch_cards().unwrap() else {
            unreachable!()
        };
        ...
        for i in 0..6 {
            ...
            let Some(c) = assets.patch_card4(c.id) else {
                continue;
            };
            match c.effect() {
                crate::rom::PatchCard4Effect::MegaFolder(v) => mega += v as usize,
                crate::rom::PatchCard4Effect::GigaFolder(v) => giga += v as usize,
                _ => {}
            }
        }
        ...
        crate::save::FolderLimits {
            ...
            reg_memory: Some(self.buf[0x2148] + 4),
