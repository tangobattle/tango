...
lobby-ready = 準備完了
lobby-ready-committed = 準備完了
lobby-unready = 取消
lobby-ready-yes = 準備完了
lobby-ready-no = 未準備
lobby-match-starting = 開始中…
lobby-reveal-setup = セットアップ公開
...
replays-filter-game = ゲーム
replays-filter-opponent = 相手
replays-filter-all-games = すべて
replays-filter-all-opponents = すべて
