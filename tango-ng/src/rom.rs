//! ROM discovery, copied from `tango/src/rom.rs` (minus the `Scanner`
//! alias — tango-ng scans on a worker thread and hands the result to the
//! UI loop instead of sharing a live scanner).
