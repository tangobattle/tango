...
pub struct Updater {
    // tango rode iced's ambient runtime; tango-ng passes its own Handle.
...
impl Updater {
    ...
    pub fn new(runtime: tokio::runtime::Handle, path: &std::path::Path, allow_prerelease_upgrades: bool) -> Self {
