...
// TANGO PATCH (see /vendor/sctp-proto/TANGO-PATCHES.md): 200ms (the RFC 4960
// delayed-SACK default) inflates the sender's RTT estimate — and with it the
// RTO — on low-rate streams. 20ms matches libdatachannel's usrsctp tuning.
