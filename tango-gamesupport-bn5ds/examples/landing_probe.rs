...
fn main() {
    ...
    support.prime(&mut a, match_type, None).expect("pair A prime");
    ...
    match mode.as_str() {
        ...
        "walked" => {
            support.prime(&mut b, match_type, None).expect("pair B prime");
        ...
        "twin" => support.prime(&mut b, match_type, None).expect("pair B prime"),
